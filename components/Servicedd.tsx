...
const people = [
  { name: 'Pilih Service' },
  { name: 'kreatin Treatment(FREE HAIR COLORING)' },
  { name: 'Korean invisible Hair Extension' },
  { name: 'Hair Cutting model' },
  { name: 'Get polish (Free Foot SPA)' },
]

export default function Servicedd() {
